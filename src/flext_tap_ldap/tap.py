...
class FlextTapLDAP(Tap):
    ...
    # TODO(@flext-team): Use centralized LDAP schema when flext-meltano common_schemas is available (https://github.com/flext-team/flext-meltano/issues/1)  # noqa: FIX002 - Tracked in issue
