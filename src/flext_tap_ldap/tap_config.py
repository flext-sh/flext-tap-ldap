...
class TapLDAPConfig(FlextConfig):
    ...
    Uses FlextLdapModels.ConnectionConfig from flext-ldap to eliminate duplication.
    """
    ...
    def create_with_defaults(cls, **overrides: object) -> TapLDAPConfig:
        ...
        # Use FlextLdapModels.ConnectionConfig defaults
        ...
        # Create FlextLdapModels.ConnectionConfig with proper parameters
        port_val = ldap_defaults.get("port", 389)
        timeout_val = ldap_defaults.get("timeout_seconds", 30)
        ldap_connection = FlextLdapModels.ConnectionConfig.model_validate(
            {
