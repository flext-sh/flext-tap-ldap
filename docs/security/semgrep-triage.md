...
```yaml
        1  # Generated by `flext-infra codegen conform` for flext-tap-ldap — DO NOT EDIT.
        2  version: 2
        3  updates:
...
**Classe**: Insecure Configuration · **Local**: `pyproject.toml:620`
...
```toml
      616  all = true
      617  in_place = true
      618  sort_first = ["build-system", "dependency-groups", "project", "tool"]
      619  
>>>   620  [tool.uv]
      621  link-mode = "copy"
      622  
      623  [tool.vulture]
      624  exclude = ["*/_protocols/*"]
```
