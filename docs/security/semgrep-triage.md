...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 620 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-tap-ldap.json`
