...
- **LDAP Directory Extraction**: Real-time data extraction from LDAP servers
- **LDIF File Processing**: Batch processing of LDIF files
- **Multiple Stream Types**: Users, Groups, Organizational Units, Schema, and Custom streams
